...
<section class="akismet-setup-instructions">
	<h2 class="akismet-setup-instructions__heading"><?php esc_html_e(
   ...
   "akismet",
	...
	<h3 class="akismet-setup-instructions__subheading">
		<?php echo esc_html__(
    "Protect your site from comment spam and contact form spam — automatically.",
    "akismet",
  ); ?>
	</h3>
...
?>
			<div class="akismet-setup-instructions__body">
				...
				<p class="akismet-setup-instructions__text">
					<?php echo esc_html__(
       "Learns from billions of spam signals across the web to stop junk before it reaches you.",
       "akismet",
     ); ?>
				</p>
			</div>
...
?>
			<div class="akismet-setup-instructions__body">
				...
				<p class="akismet-setup-instructions__text">
					<?php echo esc_html__(
       "Akismet runs quietly in the background, saving you hours of manual moderation.",
       "akismet",
     ); ?>
				</p>
			</div>
...
?>
			<div class="akismet-setup-instructions__body">
				...
				<p class="akismet-setup-instructions__text">
					<?php echo esc_html__(
       "Seamlessly integrates with plugins like Elementor, Contact Form 7, Jetpack and WPForms.",
       "akismet",
     ); ?>
				</p>
			</div>
...
?>
			<div class="akismet-setup-instructions__body">
				...
				<p class="akismet-setup-instructions__text">
					<?php echo esc_html__(
       "Name your own price for personal sites. Businesses start on a paid plan.",
       "akismet",
     ); ?>
				</p>
			</div>
	...
	<?php if (empty($use_jetpack_connection)):
   Akismet::view("get", [
     "text" => __("Get started", "akismet"),
     "classes" => ["akismet-button", "akismet-is-primary", "akismet-setup-instructions__button"],
