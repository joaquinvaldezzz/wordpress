...
<div id="akismet-plugin-container">
  ...
  "regular-text code " . $akismet_user->status,
    ...
    checked(
            true,
            in_array(get_option("akismet_show_user_comments_approved"), [false, "1", "true"], true),
          ); ?>
										/>
						...
						<table class="akismet-account">
							<tbody>
								...
								<tr>
									...
									<td>
										<?php if (Akismet::USER_STATUS_CANCELLED === $akismet_user->status):
						...
						<div class="akismet-card-actions">
							<?php if ($akismet_user->status === Akismet::USER_STATUS_ACTIVE): ?>
								<div class="akismet-card-actions__secondary-action">
									<a href="https://akismet.com/account?utm_source=akismet_plugin&amp;utm_campaign=plugin_static_link&amp;utm_medium=in_plugin&amp;utm_content=account_overview" class="akismet-external-link" aria-label="Account overview on akismet.com"><?php esc_html_e(
           "Account overview",
           "akismet",
         ); ?></a>
								</div>
